    ...
    <table id="example1" class="table table-bordered  table-striped">
        ...
        <tbody>
            ...
            <td>
                ...
                <td><?= isset($kk['tgl_update']) ? tgl_indo($kk['tgl_update']) : '' ?></td>
                <td>
        ...
        <div class="modal-dialog" role="document">
            ...
            <script>
                function exportToPDF() {
                    window.location.href = '<?= base_url('admin/kepala_keluarga/export_pdf') ?>';
                }

                function exportToExcel() {
                    window.location.href = '<?= base_url('admin/kepala_keluarga/export_excel') ?>';
                }
            </script>
