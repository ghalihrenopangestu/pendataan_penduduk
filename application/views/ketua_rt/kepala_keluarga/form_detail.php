    ...
    <div class="modal fade" id="uploadKK<?= $id_kk ?>" tabindex="-1" role="dialog"
        ...
        <div class="col-lg-12">
            <h4 class="text-bold">Anggota Keluarga
                ...
                <a href="<?= base_url('ketua_rt/kepala_keluarga/export_pdf_kk/') . $id_kk ?>" class="btn btn-info btn-xs export-pdf-btn"><i class="fa fa-file-pdf"></i> PDF</a>
                <!-- Tombol Excel -->
                <a href="<?= base_url('ketua_rt/kepala_keluarga/export_excel_kk/') . $id_kk ?>" class="btn btn-success btn-xs"><i class="fa fa-file-excel"></i> Excel</a>
            </h4>
