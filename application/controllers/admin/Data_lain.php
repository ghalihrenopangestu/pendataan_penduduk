...
public function export_pdf()
{
    ...
    $data['data'] = $this->m_data_lain->view()->result(); // Mengambil data dari model
  ...
  <th>Ketua RT</th>
    ...
    foreach ($data['data'] as $data_lain) {
       $html .= ' 
       <tr>
       <td>' . $no . '</td>
   ...
   $dompdf->loadHtml($html);
    ...
    $dompdf->render();
    $dompdf->stream("DataLain.pdf", array("Attachment" => false));
}
...
public function export_excel()
{
    ...
    $data = $this->m_data_lain->view(); // Ganti dengan nama model dan method yang sesuai
    ...
    header('Content-Disposition: attachment;filename="DataLain.xlsx"');
