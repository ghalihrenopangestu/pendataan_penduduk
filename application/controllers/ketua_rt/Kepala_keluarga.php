...
public function export_pdf()
{
    ...
    <div class="center"><h1>Data Kepala Keluarga RT ' . $this->session->userdata('no_rt') . '</h1></div>';

    $data = $this->m_kk->view_id_kk();
...
public function export_excel()
{
    ...
    // Set the title
    $sheet->setCellValue('A1', 'Data Kepala Keluarga RT ' . $this->session->userdata('no_rt'));
